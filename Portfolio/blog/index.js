...
var client_blog_Main = function() { };
client_blog_Main.__name__ = true;
client_blog_Main.main = function() {
	var tmp = window.document.getElementById("app");
	var tmp1 = new tink_state__$Observable_ConstObservable(1);
	var tmp2 = new tink_state_internal_AutoObservable(tink_state_internal__$AutoObservable_Computation.sync(function() {
		return function(languageIndex) {
			var hxxMeta = { };
			var attr = { className : tink_domspec_ClassName.ofString("flex flex-col gap-y-12 justify-center items-center")};
			var __r = [];
			var hxxMeta1 = { };
			var attr1 = { className : tink_domspec_ClassName.ofString("h-40 w-full flex justify-center items-end")};
			var hxxMeta2 = { };
			...
			var children1 = [coconut_vdom_Html.H1.vnode(attr2,hxxMeta2.key,hxxMeta2.ref,children)];
			__r.push(coconut_vdom_Html.DIV.vnode(attr1,hxxMeta1.key,hxxMeta1.ref,children1));
			var _g = 0;
			var _g1 = client_blogpost_BlogpostList.infos;
			while(_g < _g1.length) {
				var item = _g1[_g];
				++_g;
				var hxxMeta1 = { };
				var attr1 = { href : "posts/" + item.fileName + ".html", className : tink_domspec_ClassName.ofString("w-11/12")};
				var hxxMeta2 = { };
				var attr2 = { className : tink_domspec_ClassName.ofString("square-highlight w-full p-4")};
				var __r1 = [];
				var hxxMeta3 = { };
				var attr3 = { className : tink_domspec_ClassName.ofString("flex mb-4")};
				var __r2 = [];
				var hxxMeta4 = { };
				var attr4 = { className : tink_domspec_ClassName.ofString("text-tertiary w-3/4")};
				var s = item.title;
				var children = s == null ? null : coconut_vdom__$Html_Text.inst.vnode(s,null,null,null);
				__r2.push(coconut_vdom_Html.H3.vnode(attr4,hxxMeta4.key,hxxMeta4.ref,[children]));
				var hxxMeta5 = { };
				var attr5 = { className : tink_domspec_ClassName.ofString("text-grey w-1/4 text-right")};
				var children1;
				if(item.publishDate == null) {
					children1 = coconut_vdom__$Html_Text.inst.vnode("WIP",null,null,null);
				} else {
					var s1 = DateTools.format(HxOverrides.strDate(item.publishDate),"%d/%m/%Y");
					children1 = s1 == null ? null : coconut_vdom__$Html_Text.inst.vnode(s1,null,null,null);
				}
				__r2.push(coconut_vdom_Html.H4.vnode(attr5,hxxMeta5.key,hxxMeta5.ref,[children1]));
				__r1.push(coconut_vdom_Html.DIV.vnode(attr3,hxxMeta3.key,hxxMeta3.ref,__r2));
				var hxxMeta6 = { };
				var attr6 = { className : tink_domspec_ClassName.ofString("text-justify text-lg")};
				var s2 = item.description;
				var children2 = s2 == null ? null : coconut_vdom__$Html_Text.inst.vnode(s2,null,null,null);
				__r1.push(coconut_vdom_Html.P.vnode(attr6,hxxMeta6.key,hxxMeta6.ref,[children2]));
				var children3 = [coconut_vdom_Html.DIV.vnode(attr2,hxxMeta2.key,hxxMeta2.ref,__r1)];
				__r.push(coconut_vdom_Html.A.vnode(attr1,hxxMeta1.key,hxxMeta1.ref,children3));
			}
			return coconut_vdom_Html.DIV.vnode(attr,hxxMeta.key,hxxMeta.ref,__r);
		};
	}),null);
	coconut_vdom_Renderer.mountInto(tmp,client_view_App.fromHxx({ },{ nestedNess : tmp1, renderChildren : tmp2}));
};
var client_blogpost_BlogpostList = function() { };
client_blogpost_BlogpostList.__name__ = true;
...
client_blogpost_BlogpostList.infos = [{ description : "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut egestas, nunc id molestie consectetur, nunc justo commodo enim, id luctus augue eros vitae dolor. Nullam eu dapibus ante. Morbi mattis elementum ante, a maximus dolor tempus ut. Nunc posuere lacus vitae sagittis tincidunt. Phasellus eu nisl ut enim congue elementum vel sit amet nisl. In id nisl tempor, posuere tellus eu, dignissim augue. Cras eget purus ut mi venenatis fringilla in a mauris. Phasellus vehicula venenatis nisl et vestibulum. Phasellus ante eros, aliquam nec ipsum convallis, pulvinar ornare mauris. Duis efficitur bibendum efficitur. Praesent eget rhoncus tellus, placerat gravida ante. Nullam egestas justo ut tortor lacinia pulvinar. Aenean accumsan dolor ex, et mollis eros pulvinar in. Quisque molestie vitae mauris ut vestibulum. ", title : "C'est un test", status : "OK", fileName : "presentation", publishDate : null},{ description : "HEY j'aimerai tester le changement\nY a du texte", title : "Gros titre", status : "OK", fileName : "test", publishDate : null}];
