...
var client_blogpost_Main = function() { };
client_blogpost_Main.main = function() {
	$(".blogpost details").each(function(index,element) {
		element.className += " square-highlight";
	});
	coconut_vdom_Renderer.mountInto(window.document.getElementById("app"),client_view_App.fromHxx({ },{ nestedNess : new tink_state__$Observable_ConstObservable(2)}));
};
