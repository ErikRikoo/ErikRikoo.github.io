...
client_WorkData.allWorkItem = client_WorkData.sortNMapIndex([{ title : "Age of Empire 4", path : "./images/showoff/aoe4/aoe4_main.jpg", type : tink_pure_List.fromArray(["Game","Tech"]), value : 1, display : function(d) {
	...
	var hxxMeta = { };
	var attr = { className : tink_domspec_ClassName.ofString("flex-column-centered")};
	var __r = [];
	__r.push(coconut_vdom__$Html_Text.inst.vnode("I created this Post Processing in a day afer discussing with a friend about a medieval inspired game.\r\n                        We brainsormed a bit and imagined cinematics as fading medieval gravure. Doing this one picture at a time would \r\n                        takes a lot of drawing time. Thus I looked for a way to automatize it.  So here we go after a day of R&D in Unity\r\n                        the above result. This made a lot of impressions on both Discord and Twitter so I decided to create some breakdown of the effect:",null,null,null));
	var hxxMeta1 = { };
	var __r1 = [];
	__r.push(coconut_vdom_Html.IFRAME.vnode({ width : 480, height : 270, src : "https://www.youtube.com/embed/bd1N3QcwU6M", title : "Medieval Drawing Breakdown", allow : "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"},hxxMeta1.key,hxxMeta1.ref,__r1));
	__r.push(coconut_vdom__$Html_Text.inst.vnode("For now, the effect is a bit on pause but I started a written breakdown where the first part can be used as\r\n                        a reference for any Renderer Feature in Unity:",null,null,null));
	var hxxMeta1 = { };
	var __r1 = [];
	var hxxMeta2 = { };
	var hxxMeta3 = { };
	...
	__r1.push(coconut_vdom_Html.LI.vnode({ },hxxMeta2.key,hxxMeta2.ref,children1));
	__r.push(coconut_vdom_Html.UL.vnode({ },hxxMeta1.key,hxxMeta1.ref,__r1));
	return client_WorkData.defaultDisplay(d1,tmp,coconut_vdom_Html.DIV.vnode(attr,hxxMeta.key,hxxMeta.ref,__r));
