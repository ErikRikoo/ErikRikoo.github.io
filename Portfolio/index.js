...
client_view_App.prototype = $extend(coconut_vdom_View.prototype,{
	...
	,render: function() {
		var hxxMeta = { };
		var __r = [];
		__r.push(client_view_Nav.fromHxx({ },{ }));
		__r.push(client_view_CurriculumChoice.fromHxx({ },{ }));
		__r.push(client_view_Presentation.fromHxx({ },{ }));
...
var client_view_CurriculumChoice = function(__coco_data_,implicits) {
...
client_view_CurriculumChoice.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_CurriculumChoice.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_CurriculumChoice.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_CurriculumChoice(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_CurriculumChoice.__super__ = coconut_vdom_View;
client_view_CurriculumChoice.prototype = $extend(coconut_vdom_View.prototype,{
	viewDidMount: function() {
		var _gthis = this;
		...
		choiceDivs.each(function(index,element) {
			_gthis.generateContent(index,element);
		});
	}
	,render: function() {
		var hxxMeta = { };
		var attr = { className : tink_domspec_ClassName.ofString("fullscreen background")};
		var __r = [];
		var hxxMeta1 = { };
		var attr1 = { className : tink_domspec_ClassName.ofString("h-full w-full flex flex-col justify-center items-center")};
		var __r1 = [];
		var hxxMeta2 = { };
		var attr2 = { className : tink_domspec_ClassName.ofString("w-full flex justify-center items-center")};
		var __r2 = [];
		var hxxMeta3 = { };
		var _g = $bind(this,this.onChoiceChanged);
		var delta = -1;
		var attr3 = function() {
			_g(delta);
		};
		var attr4 = { className : tink_domspec_ClassName.ofString("material-icons ml-8 font-64"), onclick : attr3};
		var children = [coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,"arrow_back_ios",null,null,null)];
		__r2.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.SPAN,attr4,hxxMeta3.key,hxxMeta3.ref,children));
		var hxxMeta3 = { };
		var attr3 = { className : tink_domspec_ClassName.ofString("curriculum-choice")};
		var __r3 = [];
		var hxxMeta4 = { };
		var __r4 = [];
		__r3.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,{ className : tink_domspec_ClassName.ofString("own-order-0")},hxxMeta4.key,hxxMeta4.ref,__r4));
		var hxxMeta4 = { };
		var __r4 = [];
		__r3.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,{ className : tink_domspec_ClassName.ofString("own-order-1")},hxxMeta4.key,hxxMeta4.ref,__r4));
		var hxxMeta4 = { };
		var __r4 = [];
		__r3.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,{ className : tink_domspec_ClassName.ofString("own-order-2")},hxxMeta4.key,hxxMeta4.ref,__r4));
		__r2.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr3,hxxMeta3.key,hxxMeta3.ref,__r3));
		var hxxMeta3 = { };
		var _g1 = $bind(this,this.onChoiceChanged);
		var delta1 = 1;
		var attr3 = function() {
			_g1(delta1);
		};
		var attr4 = { className : tink_domspec_ClassName.ofString("material-icons mr-8 font-64 interactible"), onclick : attr3};
		...
		var hxxMeta2 = { };
		var attr2 = { className : tink_domspec_ClassName.ofString("text-center mt-4")};
		var children = [coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,"Normal",null,null,null)];
		__r1.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.H2,attr2,hxxMeta2.key,hxxMeta2.ref,children));
		__r.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr1,hxxMeta1.key,hxxMeta1.ref,__r1));
		__r.push(client_view_utilities_scroll_ScrollArrow.fromHxx({ },{ }));
...
client_view_Media.__name__ = true;
client_view_Media.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_Media.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_Media.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_Media(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_Media.__super__ = coconut_vdom_View;
...
client_view_Nav.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_Nav.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_Nav.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_Nav(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_Nav.__super__ = coconut_vdom_View;
client_view_Nav.prototype = $extend(coconut_vdom_View.prototype,{
	render: function() {
		var hxxMeta = { };
...
var client_view_Presentation = function(__coco_data_,implicits) {
	var _gthis = this;
	this._coco_implicits = implicits;
	this.__initAttributes(__coco_data_);
	var snapshot = null;
...
client_view_Presentation.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_Presentation.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_Presentation.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_Presentation(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_Presentation.__super__ = coconut_vdom_View;
client_view_Presentation.prototype = $extend(coconut_vdom_View.prototype,{
	render: function() {
		var hxxMeta = { };
...
var client_view_experiences_ExperienceItem = function(__coco_data_,implicits) {
	var _gthis = this;
	this._coco_implicits = implicits;
	this.__initAttributes(__coco_data_);
	var snapshot = null;
...
client_view_experiences_ExperienceItem.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_experiences_ExperienceItem.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_experiences_ExperienceItem.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_experiences_ExperienceItem(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_experiences_ExperienceItem.__super__ = coconut_vdom_View;
client_view_experiences_ExperienceItem.prototype = $extend(coconut_vdom_View.prototype,{
	render: function() {
		...
		var children1 = new tink_state__$Observable_ConstObservable("2020-2021",null);
		var children2 = new tink_state__$Observable_ConstObservable("Entreprise",null);
		var children3 = new tink_state_internal_AutoObservable(tink_state_internal__$AutoObservable_Computation.sync(function() {
...
var client_view_experiences_Experiences = function(__coco_data_,implicits) {
	var _gthis = this;
	this._coco_implicits = implicits;
	this.__initAttributes(__coco_data_);
	var snapshot = null;
...
client_view_experiences_Experiences.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_experiences_Experiences.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_experiences_Experiences.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_experiences_Experiences(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_experiences_Experiences.__super__ = coconut_vdom_View;
client_view_experiences_Experiences.prototype = $extend(coconut_vdom_View.prototype,{
	viewDidMount: function() {
	...
	,render: function() {
		...
		var children = [coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,"Experiences",null,null,null)];
		...
		__r.push(client_view_experiences_ExperienceItem.fromHxx({ },{ }));
		__r.push(client_view_experiences_ExperienceItem.fromHxx({ },{ }));
		__r.push(client_view_experiences_ExperienceItem.fromHxx({ },{ }));
		__r.push(client_view_experiences_ExperienceItem.fromHxx({ },{ }));
		return coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,{ },hxxMeta.key,hxxMeta.ref,__r);
...
var client_view_formations_FormationItem = function(__coco_data_,implicits) {
	var _gthis = this;
	this._coco_implicits = implicits;
	this.__initAttributes(__coco_data_);
	var snapshot = null;
...
client_view_formations_FormationItem.__name__ = true;
client_view_formations_FormationItem.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_formations_FormationItem.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_formations_FormationItem.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_formations_FormationItem(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_formations_FormationItem.__super__ = coconut_vdom_View;
client_view_formations_FormationItem.prototype = $extend(coconut_vdom_View.prototype,{
	render: function() {
		var hxxMeta = { };
		var attr = { className : tink_domspec_ClassName.ofString("lg:h-screen w-full flex justify-center items-center p-8")};
		var hxxMeta1 = { };
		var attr1 = { className : tink_domspec_ClassName.ofString("square-highlight lg:h-3/4 sm:h-full flex flex-col justify-center p-8 m-8")};
		var children = new tink_state_internal_AutoObservable(tink_state_internal__$AutoObservable_Computation.sync(function() {
			return tink_pure_List.fromArray(["Poste","Poste"]);
		}),null,null);
		var children1 = new tink_state__$Observable_ConstObservable("2020-2021",null);
		...
		var children4 = [client_view_utilities_BasicItem.fromHxx({ },{ headers : children, dates : children1, place : children2, content : children3})];
		var children = [coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr1,hxxMeta1.key,hxxMeta1.ref,children4)];
		return coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr,hxxMeta.key,hxxMeta.ref,children);
	}
	,__initAttributes: function(attributes) {
	}
});
var client_view_formations_Formations = function(__coco_data_,implicits) {
	var _gthis = this;
	this._coco_implicits = implicits;
	this.__initAttributes(__coco_data_);
	var snapshot = null;
...
client_view_formations_Formations.__name__ = true;
client_view_formations_Formations.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_formations_Formations.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_formations_Formations.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_formations_Formations(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_formations_Formations.__super__ = coconut_vdom_View;
client_view_formations_Formations.prototype = $extend(coconut_vdom_View.prototype,{
	render: function() {
		var hxxMeta = { };
		var __r = [];
		var hxxMeta1 = { };
		...
		var hxxMeta3 = { };
		var attr2 = { className : tink_domspec_ClassName.ofString("text-tertiary")};
		var children = [coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,"Formations",null,null,null)];
		var children1 = [coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.H1,attr2,hxxMeta3.key,hxxMeta3.ref,children)];
		__r1.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr1,hxxMeta2.key,hxxMeta2.ref,children1));
		__r1.push(client_view_utilities_scroll_ScrollArrow.fromHxx({ },{ }));
		__r.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr,hxxMeta1.key,hxxMeta1.ref,__r1));
		var hxxMeta1 = { };
		var attr = { className : tink_domspec_ClassName.ofString("fullscreen grid lg:grid-cols-2 sm:grid-cols-1 p-8")};
		var __r1 = [];
		__r1.push(client_view_formations_FormationItem.fromHxx({ },{ }));
		__r1.push(client_view_formations_FormationItem.fromHxx({ },{ }));
		__r.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr,hxxMeta1.key,hxxMeta1.ref,__r1));
		return coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,{ },hxxMeta.key,hxxMeta.ref,__r);
	}
...
var client_view_utilities_BasicItem = function(__coco_data_,implicits) {
	var _gthis = this;
	this._coco_implicits = implicits;
	this.__coco_headers = new coconut_ui_internal_Slot(this,null,null);
	this.__coco_dates = new coconut_ui_internal_Slot(this,null,null);
	this.__coco_place = new coconut_ui_internal_Slot(this,null,null);
...
client_view_utilities_BasicItem.__name__ = true;
client_view_utilities_BasicItem.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_utilities_BasicItem.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_utilities_BasicItem.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_utilities_BasicItem(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_utilities_BasicItem.__super__ = coconut_vdom_View;
client_view_utilities_BasicItem.prototype = $extend(coconut_vdom_View.prototype,{
	render: function() {
		var hxxMeta = { };
		var attr = { className : tink_domspec_ClassName.ofString("w-full")};
		var __r = [];
		var hxxMeta1 = { };
		var attr1 = { className : tink_domspec_ClassName.ofString("w-full flex mb-1")};
		var __r1 = [];
		var hxxMeta2 = { };
		var attr2 = { className : tink_domspec_ClassName.ofString("flex-grow flex flex-col")};
		var __r2 = [];
		var _g = new tink_pure_NodeIterator(tink_state_Observable.get_value(this.__coco_headers));
		while(_g.list.length > 0) {
			var i = _g.next();
			var hxxMeta3 = { };
			var attr3 = { className : tink_domspec_ClassName.ofString("flex-grow")};
			var children = i == null ? null : coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,i,null,null,null);
			__r2.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.H4,attr3,hxxMeta3.key,hxxMeta3.ref,[children]));
		}
		__r1.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr2,hxxMeta2.key,hxxMeta2.ref,__r2));
		var hxxMeta2 = { };
		var attr2 = { className : tink_domspec_ClassName.ofString("w-auto")};
		var s = tink_state_Observable.get_value(this.__coco_dates);
		var children = s == null ? null : coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,s,null,null,null);
		__r1.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.H4,attr2,hxxMeta2.key,hxxMeta2.ref,[children]));
		__r.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr1,hxxMeta1.key,hxxMeta1.ref,__r1));
		var hxxMeta1 = { };
		var attr1 = { className : tink_domspec_ClassName.ofString("ml-8 w-full mb-3")};
		var s = tink_state_Observable.get_value(this.__coco_place);
		var children = s == null ? null : coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,s,null,null,null);
		...
		var __r1 = [];
		var this1 = tink_state_Observable.get_value(this.__coco_content);
		if((this1 == null ? 0 : this1.length) == 1) {
			var _g = new tink_pure_NodeIterator(tink_state_Observable.get_value(this.__coco_content));
			while(_g.list.length > 0) {
				var i = _g.next();
				var hxxMeta2 = { };
				var children = i == null ? null : coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,i,null,null,null);
				__r1.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.P,{ },hxxMeta2.key,hxxMeta2.ref,[children]));
			}
		} else {
			var hxxMeta2 = { };
			var __r2 = [];
			...
			while(_g.list.length > 0) {
				...
				var hxxMeta3 = { };
				var children = i == null ? null : coconut_diffing_FactoryTools.vnode(coconut_vdom__$Html_Text.inst,i,null,null,null);
				__r2.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.LI,{ },hxxMeta3.key,hxxMeta3.ref,[children]));
			}
			__r1.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.UL,{ },hxxMeta2.key,hxxMeta2.ref,__r2));
		}
		__r.push(coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr1,hxxMeta1.key,hxxMeta1.ref,__r1));
		return coconut_diffing_FactoryTools.vnode(coconut_vdom_Html.DIV,attr,hxxMeta.key,hxxMeta.ref,__r);
	}
	,__initAttributes: function(attributes) {
		this.__coco_headers.setData(attributes.headers);
		this.__coco_dates.setData(attributes.dates);
		this.__coco_place.setData(attributes.place);
