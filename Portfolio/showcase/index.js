...
var client_showcase_Main = function() { };
client_showcase_Main.main = function() {
	...
	var tmp1 = new tink_state_internal_AutoObservable(tink_state_internal__$AutoObservable_Computation.sync(function() {
		return function(languageIndex) {
			...
			return client_view_showcase_ShowcaseView.fromHxx({ },{ languageIndex : compute});
		};
	}),null);
...
var client_view_showcase_ShowcaseView = function(__coco_data_,implicits) {
	var _gthis = this;
	this._coco_implicits = implicits;
	this.__coco_languageIndex = new coconut_ui_internal_Slot(this,null,null);
	this.__initAttributes(__coco_data_);
...
client_view_showcase_ShowcaseView.fromHxx = function(hxxMeta,attributes) {
	var _g = client_view_showcase_ShowcaseView.__factory;
	var tmp;
	if(_g == null) {
		tmp = client_view_showcase_ShowcaseView.__factory = new coconut_diffing_internal_WidgetFactory(function(__coco_data_,implicits) {
			return new client_view_showcase_ShowcaseView(__coco_data_,implicits);
		},function(v,attr) {
			v.__initAttributes(attr);
		});
	} else {
...
client_view_showcase_ShowcaseView.__super__ = coconut_vdom_View;
client_view_showcase_ShowcaseView.prototype = $extend(coconut_vdom_View.prototype,{
	render: function() {
		var hxxMeta = { };
		var hxxMeta1 = { };
		var attr = { className : tink_domspec_ClassName.ofString("min-fullscreen pt-24")};
		var hxxMeta2 = { };
		var attr1 = { className : tink_domspec_ClassName.ofString("w-full flex justify-center items-center")};
		var hxxMeta3 = { };
		var attr2 = { className : tink_domspec_ClassName.ofString("text-tertiary")};
		var children = [coconut_vdom__$Html_Text.inst.vnode("Showcase",null,null,null)];
		var children1 = [coconut_vdom_Html.H1.vnode(attr2,hxxMeta3.key,hxxMeta3.ref,children)];
		var children = [coconut_vdom_Html.DIV.vnode(attr1,hxxMeta2.key,hxxMeta2.ref,children1)];
		var children1 = [coconut_vdom_Html.DIV.vnode(attr,hxxMeta1.key,hxxMeta1.ref,children)];
		return coconut_vdom_Html.DIV.vnode({ },hxxMeta.key,hxxMeta.ref,children1);
	}
	,__initAttributes: function(attributes) {
		this.__coco_languageIndex.setData(attributes.languageIndex);
	}
